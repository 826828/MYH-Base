...
- (void)     sendRequest2:(NSMutableURLRequest *)request
    ...
    NSURLSessionUploadTask *uploadTask = [_httpManager uploadTaskWithRequest:request fromData:nil progress:^(NSProgress *downloadProgress){NSLog(@"progress is %@", downloadProgress);} completionHandler:^(NSURLResponse *response, id responseObject, NSError *error) {
